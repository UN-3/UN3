...
import org.un.common.overlay.server.UnChannelInitializer;
...
public class PeerClient {
  ...
  public PeerClient() {
    workerGroup = new NioEventLoopGroup(0, new ThreadFactory() {
      ...
      public Thread newThread(Runnable r) {
        return new Thread(r, "UnJClientWorker-" + cnt.getAndIncrement());
      }
    });
  }
  ...
  private ChannelFuture connectAsync(String host, int port, String remoteId,
    ...
    UnChannelInitializer unChannelInitializer = ctx
        .getBean(UnChannelInitializer.class, remoteId);
