...
import org.un.core.net.UnNetHandler;
...
public class Channel {
  ...
  @Autowired
  private UnNetHandler unNetHandler;
  @Autowired
  ...
  private UnState unState = UnState.INIT;
  ...
  public void init(ChannelPipeline pipeline, String remoteId, boolean discoveryMode,
    ...
    pipeline.addLast("lengthDecode", new UnProtobufVarint32FrameDecoder(this));
  ...
  public void publicHandshakeFinished(ChannelHandlerContext ctx, HelloMessage msg) {
    ...
    setUnState(UnState.HANDSHAKE_FINISHED);
  ...
  public void setUnState(UnState unState) {
