...
import static org.un.core.config.Parameter.DatabaseConstants.EXCHANGE_COUNT_LIMIT_MAX;
import static org.un.core.config.Parameter.DatabaseConstants.PROPOSAL_COUNT_LIMIT_MAX;
...
import org.un.core.exception.NonUniqueObjectException;
...
import org.un.core.net.UnNetService;
...
public class Wallet {
  ...
  private void setTransaction(TransactionCapsule trx) {
    try {
      ...
      if ("solid".equals(Args.getInstance().getUnReferenceBlock())) {
      ...
      long expiration = chainBaseManager.getHeadBlockTimeStamp() + Args.getInstance()
          .getUnExpirationTimeInMilliseconds();
