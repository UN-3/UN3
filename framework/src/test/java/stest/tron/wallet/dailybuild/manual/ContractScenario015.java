...
public class ContractScenario015 {
  ...
  @Test(enabled = true, description = "UN TRC20 transfer token")
  public void trc20Un() {
    ...
    String contractName = "UN TRC20";
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_Scenario015_TRC20_UN");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_Scenario015_TRC20_UN");
