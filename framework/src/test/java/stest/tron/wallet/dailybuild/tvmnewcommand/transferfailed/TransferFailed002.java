...
public class TransferFailed002 {
  ...
  public void test1SendNotEnough() {
    ...
    String num = "3000001";
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendUnInsufficientBalance(uint256)", num, false, 0,
  ...
  public void test3SendUnNonexistentTarget() {
    ...
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendUnNonexistentTarget(uint256,address)", num,
  ...
  public void test4SendUnSelf() {
    ...
    String num = "1";
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendUnSelf(uint256)", num, false, 0, maxFeeLimit,
    ...
    Assert.assertEquals("transfer trx failed: Cannot transfer UN to yourself.",
  ...
  public void test5SendUnNonexistentTarget() {
    Account info;
  ...
  public void test7SendUnNonexistentTargetRevert() {
    ...
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendUnRevert(uint256,address)", num, false, 0,
            maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);
