...
public class HttpTestZenToken005 {
  ...
  public void test02GetMerkleTreeVoucherInfo() {
    HttpMethed.waitToProduceOneBlock(httpnode);
    response = HttpMethed
        .getMerkleTreeVoucherInfo(httpnode, sendNote.getUnId(), sendNote.getIndex(), 1);
    responseContent = HttpMethed.parseResponseContent(response);
    HttpMethed.printJsonContent(responseContent);
    ...
    response = HttpMethed
        .getMerkleTreeVoucherInfo(httpnode, receiveNote.getUnId(), receiveNote.getIndex(), 1000);
    responseContent = HttpMethed.parseResponseContent(response);
    HttpMethed.printJsonContent(responseContent);
  ...
  public void test03GetMerkleTreeVoucherInfoFromSolidity() {
    HttpMethed.waitToProduceOneBlock(httpnode);
    response = HttpMethed
        .getMerkleTreeVoucherInfoFromSolidity(httpSolidityNode, sendNote.getUnId(),
            sendNote.getIndex(), 1);
    responseContent = HttpMethed.parseResponseContent(response);
    HttpMethed.printJsonContent(responseContent);
    Assert.assertTrue(responseContent.toJSONString().contains("tree"));
    ...
    response = HttpMethed
        .getMerkleTreeVoucherInfoFromSolidity(httpSolidityNode, receiveNote.getUnId(),
