...
public class NodeStatisticsTest {
  ...
  public void testMessage() {
    ...
    InventoryMessage invMsgUn =
        new InventoryMessage(new ArrayList<>(), Protocol.Inventory.InventoryType.UN);
    String inventoryMessageStr = invMsgUn.toString();
    Assert.assertNotNull(inventoryMessageStr);
    statistics.addTcpInMessage(invMsgUn);
    statistics.addTcpOutMessage(invMsgUn);
    ...
    FetchInvDataMessage fetchInvDataUn =
        new FetchInvDataMessage(new ArrayList<>(), Protocol.Inventory.InventoryType.UN);
    statistics.addTcpInMessage(fetchInvDataUn);
    statistics.addTcpOutMessage(fetchInvDataUn);
    ...
    Assert.assertEquals(1, statistics.unInUnFetchInvData.getTotalCount());
    ...
    Assert.assertEquals(1, statistics.unInUns.getTotalCount());
