...
public class DepositTest {
  ...
  public void loopCallTest()
    ...
    Runtime runtime = TvmTestUtils
        .processTransactionAndReturnRuntime(aUn, DepositImpl.createRoot(manager),
            null);
    ...
    byte[] aAddress = WalletUtil.generateContractAddress(aUn);
    byte[] bAddress = WalletUtil.generateContractAddress(bUn);
  ...
  public void loopCallTestOldVersion()
    ...
    Runtime runtime = TvmTestUtils.processTransactionAndReturnRuntime(aUn, rootDeposit,
        null);
    Assert.assertNull(runtime.getRuntimeError());
    ...
    Transaction bUn = TvmTestUtils.generateDeploySmartContractAndGetTransaction(
        ...
        null);
    rootDeposit = DepositImpl.createRoot(manager);
    runtime = TvmTestUtils.processTransactionAndReturnRuntime(bUn, rootDeposit, null);
    Assert.assertNull(runtime.getRuntimeError());
