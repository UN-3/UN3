...
public class AccountVoteWitnessTest {
  ...
  private List<AccountCapsule> getAccountList() {
    ...
    final AccountCapsule accountUn =
        new AccountCapsule(
            ByteString.copyFrom("00000000001".getBytes()),
            ByteString.copyFromUtf8("Un"),
            AccountType.Normal);
    ...
    final AccountCapsule accountVivider =
        new AccountCapsule(
            ...
            AccountType.Normal);
    // accountUn addVotes
    accountUn.addVotes(accountMarcus.getAddress(), 100);
    accountUn.addVotes(accountOlivier.getAddress(), 100);
    accountUn.addVotes(accountSasaXie.getAddress(), 100);
    accountUn.addVotes(accountVivider.getAddress(), 100);

    // accountMarcus addVotes
    accountMarcus.addVotes(accountUn.getAddress(), 100);
    ...
    accountOlivier.addVotes(accountUn.getAddress(), 100);
    ...
    accountCapsuleList.add(accountUn);
  ...
  private List<WitnessCapsule> getWitnessList() {
    ...
    final WitnessCapsule witnessUn =
    ...
    witnessCapsuleList.add(witnessUn);
