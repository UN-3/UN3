...
public class UnfreezeBalanceActuatorTest {
  ...
  public void testUnfreezeBalanceForBandwidth() {
    ...
    Assert.assertEquals(accountCapsule.getUnPower(), frozenBalance);
    ...
    try {
      ...
      Assert.assertEquals(owner.getUnPower(), 0L);
  ...
  public void testUnfreezeDelegatedBalanceForBandwidth() {
    ...
    Assert.assertEquals(frozenBalance, owner.getUnPower());
    ...
    Assert.assertEquals(0L, receiver.getUnPower());
    ...
    try {
      ...
      Assert.assertEquals(0L, ownerResult.getUnPower());
