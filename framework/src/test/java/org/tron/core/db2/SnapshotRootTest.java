...
import org.un.core.db2.RevokingDbWithCacheNewValueTest.TestRevokingUnStore;
...
public class SnapshotRootTest {
  ...
  public synchronized void testRemove() {
    ...
    unDatabase = new TestRevokingUnStore("testSnapshotRoot-testRemove");
  ...
  public synchronized void testMerge() {
    unDatabase = new TestRevokingUnStore("testSnapshotRoot-testMerge");
  ...
  public synchronized void testMergeList() {
    unDatabase = new TestRevokingUnStore("testSnapshotRoot-testMergeList");
    revokingDatabase = context.getBean(SnapshotManager.class);
    revokingDatabase.enable();
    revokingDatabase.add(unDatabase.getRevokingDB());
