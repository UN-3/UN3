...
import static org.un.core.config.Parameter.ChainConstant.UN_PRECISION;
...
public class FreezeBalanceActuator extends AbstractActuator {
  ...
  public boolean execute(Object result) throws ContractExeException {
    ...
    switch (freezeBalanceContract.getResource()) {
      case BANDWIDTH:
        ...
        dynamicStore
            .addTotalNetWeight(frozenBalance / UN_PRECISION);
        break;
      case ENERGY:
        if (!ArrayUtils.isEmpty(receiverAddress)
            && dynamicStore.supportDR()) {
        ...
        dynamicStore
            .addTotalEnergyWeight(frozenBalance / UN_PRECISION);
        break;
      default:
  ...
  public boolean validate() throws ContractValidateException {
    ...
    if (frozenBalance < UN_PRECISION) {
      throw new ContractValidateException("frozenBalance must be more than 1UN");
    }
