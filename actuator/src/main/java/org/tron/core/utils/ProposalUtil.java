...
//      }
  ...
  public enum ProposalType {         // current value, value range
    ...
    ACCOUNT_UPGRADE_COST(1), // 9999 UN, [0, 100000000000] UN
    CREATE_ACCOUNT_FEE(2), // 0.1 UN, [0, 100000000000] UN
    TRANSACTION_FEE(3), // 10 Sun/Byte, [0, 100000000000] UN
    ASSET_ISSUE_FEE(4), // 1024 UN, [0, 100000000000] UN
    WITNESS_PAY_PER_BLOCK(5), // 16 UN, [0, 100000000000] UN
    WITNESS_STANDBY_ALLOWANCE(6), // 115200 UN, [0, 100000000000] UN
    CREATE_NEW_ACCOUNT_FEE_IN_SYSTEM_CONTRACT(7), // 0 UN, [0, 100000000000] UN
    ...
    ENERGY_FEE(11), // 10 Sun, [0, 100000000000] UN
    EXCHANGE_CREATE_FEE(12), // 1024 UN, [0, 100000000000] UN
    ...
    UPDATE_ACCOUNT_PERMISSION_FEE(22), // 100 UN, [0, 100000] UN
    MULTI_SIGN_FEE(23), // 1 UN, [0, 100000] UN
