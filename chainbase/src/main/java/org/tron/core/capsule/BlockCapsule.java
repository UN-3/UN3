...
public class BlockCapsule implements ProtoCapsule<Block> {
  ...
  public void addTransaction(TransactionCapsule pendingUn) {
    this.block = this.block.toBuilder().addTransactions(pendingUn.getInstance()).build();
    getTransactions().add(pendingUn);
  }
