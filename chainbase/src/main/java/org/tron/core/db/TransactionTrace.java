...
import static org.un.common.runtime.InternalTransaction.UnType.UN_CONTRACT_CALL_TYPE;
import static org.un.common.runtime.InternalTransaction.UnType.UN_CONTRACT_CREATION_TYPE;
...
import org.un.common.runtime.InternalTransaction.UnType;
...
public class TransactionTrace {
  ...
  public TransactionTrace(TransactionCapsule trx, StoreFactory storeFactory,
    ...
    switch (contractType.getNumber()) {
      case ContractType.TriggerSmartContract_VALUE:
        trxType = UN_CONTRACT_CALL_TYPE;
        break;
      case ContractType.CreateSmartContract_VALUE:
        trxType = UN_CONTRACT_CREATION_TYPE;
        break;
      default:
        trxType = UnType.UN_PRECOMPILED_TYPE;
    }
  ...
  public TransactionCapsule getUn() {
    return trx;
  }

  private boolean needVM() {
    return this.trxType == UN_CONTRACT_CALL_TYPE
        || this.trxType == UN_CONTRACT_CREATION_TYPE;
  }
  ...
  public void checkIsConstant() throws ContractValidateException, VMIllegalException {
    ...
    TriggerSmartContract triggerContractFromTransaction = ContractCapsule
        .getTriggerContractFromTransaction(this.getUn().getInstance());
    if (UN_CONTRACT_CALL_TYPE == this.trxType) {
  ...
  public void exec()
    ...
    if (UnType.UN_PRECOMPILED_TYPE != trxType) {
  ...
  public void finalization() throws ContractExeException {
    ...
    if (StringUtils.isEmpty(transactionContext.getProgramResult().getRuntimeError())) {
      for (DataWord contract : transactionContext.getProgramResult().getDeleteAccounts()) {
        deleteContract(convertToUnAddress((contract.getLast20Bytes())));
      }
    }
  }
  ...
  public static byte[] convertToUnAddress(byte[] address) {
