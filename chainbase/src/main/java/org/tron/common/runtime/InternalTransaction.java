...
public class InternalTransaction {
   ...
   */
  public InternalTransaction(Transaction trx, InternalTransaction.UnType trxType)
    ...
    this.deep = -1;
    if (trxType == UnType.UN_CONTRACT_CREATION_TYPE) {
    ...
    } else if (trxType == UnType.UN_CONTRACT_CALL_TYPE) {
  ...
  public enum UnType {
    UN_PRECOMPILED_TYPE,
    UN_CONTRACT_CREATION_TYPE,
    UN_CONTRACT_CALL_TYPE,
    UN_UNKNOWN_TYPE,
  }
