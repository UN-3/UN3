...
public class Constant {
  ...
  public static final long SUN_PER_ENERGY = 100; // 1 us = 100 SUN = 100 * 10^-6 UN
  ...
  public static final byte[] ZUN_EXPANDSEED_PERSONALIZATION = {'Z', 't', 'r', 'o', 'n', '_', 'E',
      'x',
      'p', 'a', 'n', 'd', 'S', 'e', 'e', 'd'};
  ...
  public static final String NODE_NET_MAX_UN_PER_SECOND = "node.netMaxUnPerSecond";
  ...
  public static final String UN_REFERENCE_BLOCK = "trx.reference.block";

  public static final String UN_EXPIRATION_TIME_IN_MILLIS_SECONDS = "trx.expiration.timeInMilliseconds";
