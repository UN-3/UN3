...
public class Parameter {
  ...
  public static class ChainSymbol {
    ...
    public static final byte[] UN_SYMBOL_BYTES = "_".getBytes(); // UN symbol
  }
  ...
  public class ChainConstant {
    ...
    public static final long UN_PRECISION = 1000_000L;
  }
